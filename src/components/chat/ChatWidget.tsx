  ...
  return (
    <>
      ...
      <div className="fixed z-50 bottom-[calc(15vh+9rem)] right-6 group">
        <span className="pointer-events-none absolute right-full top-1/2 -translate-y-1/2 mr-3 px-2.5 py-1 rounded-md bg-navy-800/95 border border-gold/20 text-foreground text-xs whitespace-nowrap shadow-lg opacity-0 translate-x-1 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-200">
      ...
      <div className="fixed z-50 bottom-[calc(15vh+1rem)] right-6 group">
        <span className={cn(
          "pointer-events-none absolute right-full top-1/2 -translate-y-1/2 mr-3 px-2.5 py-1 rounded-md bg-navy-800/95 border border-gold/20 text-foreground text-xs whitespace-nowrap shadow-lg transition-all duration-200",
