    ...
    <section className="container mx-auto px-4 py-12 md:py-20 text-center">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl md:text-5xl font-bold mb-6">
          <span className="text-white day-readable">AI Agents That </span>
          <span className="text-gold day-readable">Automate Conversations & Actions</span>
          <br />
          <span className="text-white day-readable text-xl md:text-3xl font-medium mt-2 block">
            Smart AI That Talks, Decides & Delivers — 24/7
          </span>
        </h1>
        
        <p className="text-lg md:text-xl text-white day-readable mb-8 max-w-3xl mx-auto opacity-95 font-light leading-relaxed">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-6 md:gap-16">
          ...
          >
            <div className="dark:bg-navy-800 dark:border-navy-700 bg-white/20 border-white/40 backdrop-blur-md border p-6 rounded-xl shadow-lg w-full
              ...
              <div className="text-left mb-4">
                <ul className="text-white day-readable text-xs space-y-1">
          ...
          >
            <div 
              className="dark:bg-navy-800 dark:border-navy-700 bg-white/20 border-white/40 backdrop-blur-md border p-6 rounded-xl shadow-lg w-full cursor-pointer 
                         hover:border-gold hover:shadow-gold/20 transition-all duration-300 hover:scale-105"
